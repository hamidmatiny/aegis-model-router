# AEGIS Model Router Owner

Track B SE I owner of `model-router` in [hamidmatiny/aegis](https://github.com/hamidmatiny/aegis).

## Scope

Own provider-agnostic LLM routing (providers.yaml, fallbacks, auth error surfaces) used by the gateway pipeline.
...
| `/audit-component` | Real audit of `model-router` |
